  ...
  const DATASETS = {
    closing: {
      ...
      cols: ["Unique Key", "Record Source", "Company", "Date", "Customer", "Request #",
        ...
        "Forman Job Order", "Request Joinkey", "Branch Owner", "Branch Owner Cut", "Estimator Cut",
    ...
    lead_journey: {
      ...
      cols: ["Request Joinkey", "Job No", "Company", "Customer", "Create Date", "Source",
        ...
        "Booked Date", "Cal Found", "Cal Event Date", "Cal Date Match", "Cal Loc Match", "Cal Link",
    ...
    scorecard: {
      ...
      cols: ["Foreman", "Month", "Month Year", "Total Jobs", "Total Packing Written",
        ...
        // the 2026-07 model: 60 automatic + 40 from the logistics team's assessment, whose
