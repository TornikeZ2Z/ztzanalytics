...
registerPage({
  ...
  render: function (host) {
    ...
    host.innerHTML = '<style id="faCss">'
      ...
      + ".fa-note{font-size:var(--t5);color:var(--faint);line-height:1.6;max-width:104ch;margin-bottom:16px}"
      ...
      // question rows
      + ".fa-q{display:flex;gap:18px;align-items:flex-start;padding:9px 0;border-bottom:1px solid var(--line);max-width:1120px}"
      + ".fa-q:last-child{border-bottom:0}"
      + ".fa-q .qt{flex:1;min-width:0}"
      + ".fa-q .qt b{font-size:var(--t3);font-weight:650;display:block}"
      + ".fa-q .qt span{font-size:var(--t5);color:var(--faint);line-height:1.55;display:block;margin-top:2px;max-width:74ch}"
